...
model {
    ...
    target += log_likelihood(1, 1, delta, N, max_T, differences_from_max_T, exp_differnces_mat, rv);
}

// Comment/uncomment below as needed
generated quantities {
    real hawkes_log_likelihood = log_likelihood(1, 1, delta, N, max_T, differences_from_max_T, exp_differnces_mat, rv);
}